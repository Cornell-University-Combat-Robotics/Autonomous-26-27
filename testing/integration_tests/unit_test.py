...
ROOT = os.getcwd()
TESTING_FOLDER = os.path.join(ROOT, "testing", "integration_tests")
TESTING_DATA_FOLDER = os.path.join(TESTING_FOLDER, "integration_testing_data")

# Valid image file extensions
IMAGE_EXTENSIONS = (".png")

def test_detect_corners(threshold, L_weight, RG_weight, BY_weight, area_threshold, huey_keyframe):
    ...
    for filename in os.listdir(FOLDER_PATH): 
        if filename.lower().endswith(IMAGE_EXTENSIONS):
            ...
            centroids = corner_detection.centroids
